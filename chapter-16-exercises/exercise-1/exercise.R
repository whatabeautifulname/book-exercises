...
ggplot(data = diamonds_sample) + geom_point(mapping = aes(y = price, x = carat))


 # Draw the same plot as above, but color each of the points based on their 
# clarity.
ggplot(data = diamonds_sample) + geom_point(mapping = aes(y = price, x = carat, color = clarity))
...
ggplot(data = diamonds_sample) + geom_point(mapping = aes())
